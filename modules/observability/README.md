...
```bash
# Edit examples/platform.yaml with your values
...
aws grafana create-workspace \
  ...
  --workspace-name observability-platform-grafana \
  --region us-west-2
```
...
kubectl wait --for=condition=Ready observabilityplatform/observability-platform --timeout=5m
```
...
kubectl get observabilityplatform observability-platform -o yaml
...
kubectl get workspace observability-platform -n observability-system -o yaml
```
